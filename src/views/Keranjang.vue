            ...
            <table class="table">
              ...
              <tbody>
                <tr v-for="(keranjang, index) in keranjangs" :key="keranjang.id">
                  ...
                  <td>{{ totalHarga }} - {{ keranjang.tanggal_mulai|moment('MMM Do YYYY') }} - {{ keranjang.tanggal_selesai|moment('MMM Do YYYY') }}</td>
                  <td align="right">Rp. {{ keranjang.products.harga }}</td>
                  <td align="right">
                    <strong>Rp. {{ keranjang.products.harga*(keranjang.tanggal_selesai-keranjang.tanggal_mulai) }}</strong>
                  </td>
...
export default {
  ...
  computed: {
    dateDiff(){
      return this.keranjangs.map(function (data) {
